...
\begin{itemize}
	...
	\bullpara{Visibility of privilege level}{
...
This technique was originally developed for the \keyword{Type 2} hypervisor VMWare Workstation (though has been used outside of virtualization for decades, first paper I could find \href{https://dl.acm.org/doi/10.1145/151220.151227}{here}.) It can also be used to speed up \keyword{Type 1} hypervisors.
\compenum {
