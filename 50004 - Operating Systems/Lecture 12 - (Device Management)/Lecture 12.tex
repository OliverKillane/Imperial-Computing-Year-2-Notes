            ...
            \begin{itemize}
                \bullpara{Buffered}{
                    ...
                    \compitem{
                        ...
                        \item Can allow for different data transfer unit sizes between devices (e.g buffer contaisn blocks).    
                    }
                }
                \bullpara{Unbuffered}{
                    \compitem{
    ...
    \section*{Linux}
        ...
        \subsection*{Character Device I/O}
            \compitem{
                ...
                \item Represented by a \struct{device\_struct} structure.
                \item \struct{device\_struct} contains a pointer to a \struct{file\_operations} struct.
            }
