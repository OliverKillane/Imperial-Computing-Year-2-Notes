...
\begin{document}
    ...
    \sidenote{Lecture Recording}{
        Lecture recording is available \href{https://imperial.cloud.panopto.eu/Panopto/Pages/Viewer.aspx?id=ac0f6548-4293-4e26-905f-adbe00bc59ef}{here}
    }
    ...
    \section*{Algorithms}
        ...
        \subsubsection*{Haskell Programs}
            ...
            \lstinputlisting[language=Haskell]{power.hs}
