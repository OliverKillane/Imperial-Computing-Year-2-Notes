\documentclass{report}
    \title{50006 - Compilers - Lecture 2}
...
\begin{document}
    ...
    \section*{Syntax Analysis}
        ...
        \subsection*{Parse Tree vs Abstract Syntax Tree}
            ...
            \centerimage{width=0.8\textwidth}{parse tree vs ast.png}
    
    \section*{Parsers}
        Parsers check the grammar is correct \& construct an \keyword{AST}. There are two types of parsers:
