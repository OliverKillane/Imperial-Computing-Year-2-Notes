...
\begin{document}
\maketitle
\lectlink{https://imperial.cloud.panopto.eu/Panopto/Pages/Viewer.aspx?id=eb856d61-1533-46cc-89f7-ae47011e5c6f}
\section*{Preamble}
...
\centerimage{width=0.9\textwidth}{network topologies}
...
\\ \halfsplit{
	\centerimage{width=0.9\textwidth}{Pinouts/568A}
}{
	\centerimage{width=0.9\textwidth}{Pinouts/568B}
}

\subsubsection*{Straight Through}
\halfsplit{
	\centerimage{width=0.9\textwidth}{Pinouts/straight through}
}{
...
\halfsplit{
	\centerimage{width=0.9\textwidth}{Pinouts/crossover}
}{
...
\halfsplit{
	\centerimage{width=0.9\textwidth}{Pinouts/crossover explained}
}{
...
\centerimage{width=\textwidth}{ethernet frame}
...
\termdef{MAC Address}{
	...
	\centerimage{width=0.7\textwidth}{MAC Address}
	\begin{center}
...
\subsection*{Switch}
\termdef{Switch}{
	\centerimage{width=0.7\textwidth}{cisco switch}
...
\section*{Topologies}
\lectlink{https://imperial.cloud.panopto.eu/Panopto/Pages/Viewer.aspx?id=1a426894-4ac4-451e-b15c-ae47011e5fcc}
\subsection*{Switched Ethernet}
\centerimage{width=0.9\textwidth}{switched ethernet}
\compitem{
...
\centerimage{width=0.9\textwidth}{internetworking ethernet}
\compitem{
...
\subsection*{Bus}
\centerimage{width=0.9\textwidth}{bus topology}
\compitem{
...
\subsection*{Ring}
\centerimage{width=0.9\textwidth}{ring topology}
\compitem{
...
\centerimage{width=0.9\textwidth}{token ring topology}
\compitem{
...
\centerimage{width=0.9\textwidth}{token ring frame}
...
\termdef{Wiring Concentrators}{
	...
	\centerimage{width=0.9\textwidth}{wiring concentrator}
}

\subsection*{Fibre Distributed Data Interface (FDDI)}
\centerimage{width=0.8\textwidth}{fibre distributed data interface}
...
\subsection*{Star}
\centerimage{width=0.5\textwidth}{star topology}
\compitem{
...
\centerimage{width=0.9\textwidth}{other topologies}
\compitem{
...
\section*{MAC}
\lectlink{https://imperial.cloud.panopto.eu/Panopto/Pages/Viewer.aspx?id=d29a1da0-0a7a-48da-9c5d-ae47011e61b1}
\centerimage{width=0.5\textwidth}{data link layer division}
...
\termdef{ALOHA Protocol}{
	...
	\centerimage{width=\textwidth}{aloha vulnerability}
	\compitem{
...
\termdef{Slotted ALOHA Protocol}{
	...
	\centerimage{width=\textwidth}{slotted aloha}
	\compitem{
...
\example{ALOHA Comparison}{
	...
	\centerimage{width=0.9\textwidth}{aloha example}
}
...
\sidenote{Required Delay}{
	\centerimage{width=0.9\textwidth}{ethernet carrier collision example}
...
\termdef{Carrier Extension}{
	...
	\centerimage{width=0.7\textwidth}{carrier extension}
...
\termdef{Frame Bursting}{
	...
	\centerimage{width=0.7\textwidth}{frame bursting}
}
...
\lectlink{https://imperial.cloud.panopto.eu/Panopto/Pages/Viewer.aspx?id=c5c6d36c-5df9-464d-9494-ae47011e63d0}
...
\centerimage{width=0.4\textwidth}{arp example}
\begin{center}
