...
\begin{document}
    ...
    \section*{Du Bois-Reymond Theorem}
        ...
        \begin{proof}
            \proofstep{$<$}{$f \prec g \Leftrightarrow lim = 0$}{$g$ grows much faster $f$}
            \proofstep{$\leq$}{$f \preccurlyeq g \Leftrightarrow lim <  \infty$}{$g$ grows much faster than $f$ or some multiple of $f$}
            \proofstep{$=$}{$f \asymp g \Leftrightarrow lim < \infty$}{$g$ grows some multiple faster than $f$}
            \proofstep{$\geq$}{$f \succcurlyeq  g \Leftrightarrow lim > \infty$}{$f$ grows much faster than $g$ or some multiple of $g$}
            \proofstep{$>$}{$f \succ g \Leftrightarrow lim > \infty$}{$f$ grows much faster $g$}
        \end{proof}
